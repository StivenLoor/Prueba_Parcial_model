...
import com.example.realtimefacedetection.ml.Modelbande;
...
private Bitmap rgbFrameBitmap;
  ...
  /*  public void abrirGaleria (View view){
    ...
    public void PersonalizedModel(View v) {
        try {
            Modelbande model = Modelbande.newInstance(getApplicationContext());
            TensorImage image = TensorImage.fromBitmap(mSelectedImage);

            Modelbande.Outputs outputs = model.process(image);
